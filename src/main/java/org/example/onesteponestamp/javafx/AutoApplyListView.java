...
public class AutoApplyListView {
  ...
  private void createTableView() {
    ...
    TableColumn<AutoApplyDTO, String> applyNoColumn = new TableColumn<>("신청번호");
    applyNoColumn.setCellValueFactory(new PropertyValueFactory<>("applyNo"));

    TableColumn<AutoApplyDTO, String> englishNameColumn = new TableColumn<>("영문명");
    englishNameColumn.setCellValueFactory(new PropertyValueFactory<>("englishName"));

    TableColumn<AutoApplyDTO, String> genderColumn = new TableColumn<>("성별");
    genderColumn.setCellValueFactory(new PropertyValueFactory<>("gender"));

    TableColumn<AutoApplyDTO, VisaType> visaTypeColumn = new TableColumn<>("비자 종류");
    visaTypeColumn.setCellValueFactory(new PropertyValueFactory<>("visaType"));

    TableColumn<AutoApplyDTO, String> inoutColumn = new TableColumn<>("입출국 구분");
    inoutColumn.setCellValueFactory(new PropertyValueFactory<>("inout"));

    TableColumn<AutoApplyDTO, Country> inoutCountryColumn = new TableColumn<>("입출국 국가");
    inoutCountryColumn.setCellValueFactory(new PropertyValueFactory<>("inoutCountry"));

    TableColumn<AutoApplyDTO, LocalDate> expectedInOutDateColumn = new TableColumn<>("입출국 예상 일자");
    expectedInOutDateColumn.setCellValueFactory(new PropertyValueFactory<>("expectedInOutDate"));

    TableColumn<AutoApplyDTO, String> approvalStatusColumn = new TableColumn<>("승인 상태");
    approvalStatusColumn.setCellValueFactory(new PropertyValueFactory<>("approvalStatus"));

    TableColumn<AutoApplyDTO, String> rejectReasonColumn = new TableColumn<>("거부 사유");
    rejectReasonColumn.setCellValueFactory(new PropertyValueFactory<>("rejectReason"));

    TableColumn<AutoApplyDTO, LocalDateTime> createdAtColumn = new TableColumn<>("신청일자");
